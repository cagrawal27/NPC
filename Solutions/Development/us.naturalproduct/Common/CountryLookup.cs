...
namespace us.naturalproduct.Common
{
    public class CountryLookup
    {
        ...
        private static string[] countryName = 
								{ "-- Select --", "Asia/Pacific Region","Europe","Andorra","United Arab Emirates","Afghanistan","Antigua and Barbuda","Anguilla","Albania","Armenia","Netherlands Antilles","Angola","Antarctica","Argentina","American Samoa","Austria","Australia","Aruba","Azerbaijan","Bosnia and Herzegovina","Barbados","Bangladesh","Belgium",
        ...
        {
            DataTable tblCountries = new DataTable("Countries");
            DataColumn ColCountryCode = new DataColumn(CountryCode, Type.GetType("System.String"));
            DataColumn ColCountryName = new DataColumn(CountryName, Type.GetType("System.String"));
            DataRow drCountry;

            tblCountries.Columns.Add(ColCountryCode);
            tblCountries.Columns.Add(ColCountryName);

            for (int i = 0; i < countryCode.Length; i++)
            {
                drCountry = tblCountries.NewRow();
                
                drCountry[CountryCode] = countryCode[i];
                
                drCountry[CountryName] = countryName[i];
                
                tblCountries.Rows.Add(drCountry);
            }
